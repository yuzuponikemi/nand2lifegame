...
class CompilationEngine:
    ...
    def compileWhile(self):
        ...
        self.vmw.writeArithmetic('~') # denial
    ...
    def compileTerm(self, SubroutineCall = False):
        ...
        while(True):
            ...
            if self.tn.tkns[self.tn.counter] == '(' and self.tn.currenttkn != '(':#subroutine
    ...
    def compileExpression(self):
        ...
        if op : self.vmw.writeArithmetic(op) ###########################
    ...
    def writePushExp(self, exp):
        ...
        if exp.isdigit() :
            ...
            if exp == 'true':self.vmw.writeArithmetic('~')
